    ...
    parameters {
        ...
        string(name: 'Usuario', defaultValue: '', description: 'Usuário Hoster')
            choice(
                ...
                choices:['V15','V16','*V16'])
            restrict(name:'01',defaultValue=false,description='teste')
            restrict(name:'02',defaultValue=false,description='teste')
            restrict(name:'03',defaultValue=false,description='teste')
            restrict(name:'04',defaultValue=false,description='teste')
            restrict(name:'05',defaultValue=false,description='teste')
            restrict(name:'06',defaultValue=false,description='teste')
            restrict(name:'07',defaultValue=false,description='teste')
            restrict(name:'08',defaultValue=false,description='teste')
            restrict(name:'09',defaultValue=false,description='teste')
