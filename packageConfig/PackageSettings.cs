...
namespace packageConfig
{
    class PackageSettings : BranchSettings
    {
        ...
        public void buildingPackage(out string packageArguments)
        {
            ...
            string aliasPublication = packageSettings.AliasPublication;
            ...
            param[4] = $"--output '{sendTo}/{aliasPublication}' ";
            param[5] = $"'{pathProject}/{packageType}/";
            param[6] = $"{aliasSolution}/{nameProj}.{solutionProject}.sln'";
            ...
            packageArguments = correctedArguments;
        }
    }
